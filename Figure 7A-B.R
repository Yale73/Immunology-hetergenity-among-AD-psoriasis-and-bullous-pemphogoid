...
APC <- subset(Merge, idents= c("moDC", "Mono", "migDC", "LC", "Mac_1", "Mac_2"))
...
newCols <- colorRampPalette(grDevices::rainbow(length(unique(anno_row$Type))))
annoCol <- newCols(length(unique(anno_row$Type)))
names(annoCol) <- unique(anno_row$Type)
...
p1 <- pheatmap(data,  
         ...
         cluster_rows = T, 
         cluster_cols = T, 
         annotation_row = anno_row,annotation_colors = annoCol,
         legend = TRUE, 
...
#####################
###########################Vlnplot
migDC <- subset(APC, idents="migDC")
Idents(migDC) <- migDC$dis

VlnPlot(migDC, features = "LAMP3",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
...
VlnPlot(migDC, features = "CCL17",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
...
VlnPlot(migDC, features = "CCL22",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
...
VlnPlot(migDC, features = "CCR7",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
...
VlnPlot(migDC, features = "CD200",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
...
VlnPlot(migDC, features = "CD80",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
...
VlnPlot(migDC, features = "CD274",pt.size=0)+ 
  #width控制箱体宽度，col控制边框颜色，fill控制填充颜色  
  geom_boxplot(width=.2,col="black",fill="white")+  
  NoLegend()+
  theme(plot.title = element_text(hjust = 0.5,vjust = .5,color = "black", face = "italic",
