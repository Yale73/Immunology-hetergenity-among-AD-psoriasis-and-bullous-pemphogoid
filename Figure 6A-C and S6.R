...
p5 <- plotGeneExpression(cellchat.HC, signaling = 'TNF', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("TNF signaling in HC")
p9 <- plotGeneExpression(cellchat.HC, signaling = 'IL4', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL4 signaling in HC")
p13 <- plotGeneExpression(cellchat.HC, signaling = 'IL17', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL17 signaling in HC")


p2 <- plotGeneExpression(cellchat.BP, signaling = 'IFN-II', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IFN-II signaling in BP")
p6 <- plotGeneExpression(cellchat.BP, signaling = 'TNF', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("TNF signaling in BP")
p10 <- plotGeneExpression(cellchat.BP, signaling = 'IL4', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL4 signaling in BP")
p14 <- plotGeneExpression(cellchat.BP, signaling = 'IL17', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL17 signaling in BP")


p3 <- plotGeneExpression(cellchat.AD, signaling = 'IFN-II', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IFN-II signaling in AD")
p7 <- plotGeneExpression(cellchat.AD, signaling = 'TNF', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("TNF signaling in AD")
p11 <- plotGeneExpression(cellchat.AD, signaling = 'IL4', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL4 signaling in AD")
p15 <- plotGeneExpression(cellchat.AD, signaling = 'IL17', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL17 signaling in AD")

p4 <- plotGeneExpression(cellchat.Pso, signaling = 'IFN-II', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IFN-II signaling in Pso")
p8 <- plotGeneExpression(cellchat.Pso, signaling = 'TNF', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("TNF signaling in Pso")
p12 <- plotGeneExpression(cellchat.Pso, signaling = 'IL4', type = 'dot', color.use = c("white", "#b2182b"))+ggtitle("IL4 signaling in Pso")
...
plot_grid(p9, p10, p11, p12, ncol = 1)
plot_grid(p13, p14, p15, p16, ncol = 1)