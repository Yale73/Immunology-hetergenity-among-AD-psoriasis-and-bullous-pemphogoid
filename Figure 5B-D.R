...
DEG.Data.C0 <- FindMarkers(C0, ident.1 = "BP", ident.2 = "HC",logfc.threshold = 0.25)
...
DEG.Data.C1 <- FindMarkers(C1, ident.1 = "BP", ident.2 = "HC",logfc.threshold = 0.25)
...
DEG.Data.C2 <- FindMarkers(C2, ident.1 = "BP", ident.2 = "HC",logfc.threshold = 0.25)
...
DEG.Data.C3 <- FindMarkers(C3, ident.1 = "BP", ident.2 = "HC",logfc.threshold = 0.25)
...
DEG.Data.C4 <- FindMarkers(C4, ident.1 = "BP", ident.2 = "HC",logfc.threshold = 0.25)
...
DEG.Data.C5 <- FindMarkers(C5, ident.1 = "BP", ident.2 = "HC",logfc.threshold = 0.25)
