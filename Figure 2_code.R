...
#"B"         "Mono"      "Cycling_2"
Tsubset <- subset(MergeF, idents= c("Trm", "Treg", "Tcm",  "CTL_1", "CTL_2", "Tmm", "CTL_3", "NK", "ILC", "Tex", "Cycling_1"))
...
FeaturePlot(Tsubset, features = "FOXP3", order = T, pt.size = 0.5)+
  ...
  theme(plot.title= element_text(color="black",hjust = 0.5, face="italic", family = "Arial", size=12),
        ...
        panel.grid=element_blank(), 
        axis.title = element_text(color='black',family= "italic",size=10),axis.ticks.length = unit(0.4,"lines"), 
        axis.ticks = element_line(color='black'), 
        axis.ticks.margin = unit(0.6,"lines"),
        axis.line = element_line(colour = "black"), 
...
Singlecellratio_plotstat(Tsubset, group_by = "group",
                         ...
                         group_by.point = "orig.ident",label.x = 1, pt.size = 0.5,
                         label = 'p.format', ncol = 4)
